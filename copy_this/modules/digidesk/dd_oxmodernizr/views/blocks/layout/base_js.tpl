...
[{if $aModuleSettings.dd_blEnabledClearInput}]
    [{if $aModuleSettings.dd_blEnabledMinJs}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/forms.min.js') priority=20}]
    [{else}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/forms.js') priority=20}]
    [{/if}]
[{/if}]
...
[{if $aModuleSettings.dd_blToBasketAnimation}]
    [{if $aModuleSettings.dd_blEnabledMinJs}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/effects.min.js') priority=20}]
    [{else}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/effects.js') priority=20}]
    [{/if}]
[{/if}]
[{* <<ENDE>> allgemeine Benutzerfreundlichkeit *}]
...
[{if $aModuleSettings.dd_blMiniBasketAmount }]
    ...
    [{if $aModuleSettings.dd_blMiniBasketjQueryUiConfirm}]
        ...
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/jquery-ui.min.js') priority=18}]
    [{/if}]

    [{* AJAX-Warenkorb *}]
    [{if $aModuleSettings.dd_blMiniBasketAjax}]
        [{if $aModuleSettings.dd_blEnabledMinJs}]
            [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/minibasket_ajax.min.js') priority=19}]
        [{else}]
            [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/minibasket_ajax.js') priority=19}]
        [{/if}]
    [{/if}]

    [{* Produktmengenänderungen im Mini-Warenkorb *}]
    [{if $aModuleSettings.dd_blEnabledMinJs}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/minibasket_amount.min.js') priority=20}]
    [{else}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/minibasket_amount.js') priority=20}]
    [{/if}]
[{/if}]
[{* <<ENDE>> Mini-Warenkorb *}]
...
[{if $aModuleSettings.dd_blBasketAmount}]
    [{* Produktmengenänderungen im Mini-Warenkorb *}]
    [{if $aModuleSettings.dd_blEnabledMinJs}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/basket_amount.min.js') priority=20}]
    [{else}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/basket_amount.js') priority=20}]
    [{/if}]
[{/if}]
...
[{if $aModuleSettings.dd_blBasketAjax}]
    [{if $aModuleSettings.dd_blEnabledMinJs}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/basket_ajax.min.js') priority=19}]
    [{else}]
        [{oxscript include=$oViewConf->getModuleUrl('digidesk','dd_oxmodernizr/out/src/js/basket_ajax.js') priority=19}]
    [{/if}]
[{/if}]
[{* <<ENDE>> Mini-Warenkorb *}]